...
```text
Challenge -> Skill / Agent support -> GitHub submission -> Review -> Documentation -> Release
```
...
The MVP focuses on three systems:

1. Challenge OS: how tasks are designed and published.
2. Submission OS: how students submit work through GitHub.
3. Review OS: how peers, agents, and instructors evaluate work.
